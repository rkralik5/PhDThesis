...
The interaction lagrangian described in Eq.~\ref{eq:NuIntLagrangian} describes two possible vertices for the neutrino interaction, as shown on Fig.~\ref{fig:FeynmanNuIntVertices}.\todo{Maybe add a note about possibly rotating the vertices so that neutrinos and leptons can annihilate and get created as well}
...
\note{Should I describe the neutrino-on-electron scattering here? - I should definitely mention it as one of the detection methods. Not sure how much I should talk about it. Leave the details to the last chapter...}
