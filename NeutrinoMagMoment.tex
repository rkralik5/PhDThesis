...
%%% OBJECTIVE / GOAL
In this analysis, I aim to detect a potential signal of the effective muon neutrino magnetic moment in the \gls{NOvA} \gls{ND}. This signal would manifest as an excess of \gls{nuone} elastic scattering interactions at low electron recoil energies, which would be indicative of the value of the effective neutrino magnetic moment, over the \gls{SM} background. If no significant excess is observed, I will establish an upper limit on the effective muon neutrino magnetic moment.
...
The best limits for $\nu_\mu$ and $\overline{\nu}_\mu$ come from accelerator-based stopped pions sources, namely LSND \cite{LSNDLimits2001.pdf} and LAMPF \cite{LAMPFAMuNuMM1990.pdf}. Stopped pion neutrino sources provide a well-understood beams of all $\nu_\mu$, $\overline{\nu}_\mu$ and $\nu_e$ with energies up to $\unit[52.8]{MeV}$. They both just compared the total number of predicted events to a background-subtracted measurement. A bit looser limit comes from accelerator-based measurements either from BNL \cite{NuoneForEMProp1990.pdf} (actually comparable) or from SPS \cite{Charm2MuonNuMM1995.pdf} (way larger limit) with similar technologies to NOvA. 
...
Thanks to the highly pure beam of muon neutrinos and antineutrinos, and to a detector especially designed for high quality reconstruction of events with electrons in the final state, \gls{NOvA} is positioned in a very good place to provide a highly competitive, and possibly even world-leading, limit on the effective muon neutrino magnetic moment.
