...
\begin{equation}
\frac{d\sigma_{\nu_e^-}}{dT_e}=\left(\frac{d\sigma_{\nu_e^-}}{dT_e}\right)_{\textsf{SM}}+\left(\frac{d\sigma_{\nu_e^-}}{dT_e}\right)_{\textsf{MAG}}.
\end{equation}
...
\left(\frac{d\sigma_{\nu_e^-}}{dT_e}\right)_{\textsf{SM}}=\frac{2G_F^2m_e}{\pi}\left\lbrace g_1^2+g_2^2\left(1-\frac{T_e}{E_{\nu}}\right)^2+g_1 g_2\frac{m_eT_e}{E_{\nu}^2}\right\rbrace,
\end{equation}
