...
\mu_\nu<1.91\times10^{-9}\mu_B\,\,\,\textsf{at}\,\,\,90\% \gls{CL}.
\end{equation} 
...
The $90\%$\gls{CL} limit on the effective muon neutrino magnetic moment in Eq.~\ref{eq:NuMMLimit} is less strict than the current world-leading limit \cite{PDG.pdf} and than the (statistics-only) previous limit from \gls{NOvA} \cite{nuMM-thesis-biaow.pdf}. However, there are several possible improvement that could improve our analysis.
