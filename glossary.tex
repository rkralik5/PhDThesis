...
\newacronym{PECorr}{PECorr}{Corrected Photo Electron}
...
\newacronym[description=Particle Identification algorithm designed to identify \ensuremath{\nu}-on-e interactions from \ensuremath{\nu_\mu}CC background]{nuoneID}{\ensuremath{\nu}-on-e\texttt{ID}}{\ensuremath{\nu}-on-e\texttt{ID}}
\newacronym[description=Particle Identification algorithm designed to identify \ensuremath{\nu}-on-e interactions from \ensuremath{\pi^0} background]{EPi0ID}{\ensuremath{E\pi^0}\texttt{ID}}{\ensuremath{E\pi^0}\texttt{ID}}