...
Both data and simulation are passed through parallel event reconstruction, identification, calibration and energy estimation algorithms.
...
\caption[NOvA detectors event topologies]{Different event topologies as seen in the NOvA detectors with corresponding Feynman diagrams. Figure is from \cite{NOvAReco.pdf}.}
\label{interactions}
\end{figure}
