...
The signal from the wavelength shifting fibres is read out by an Avalanche Photodiode (APD), converting the scintillation light into electrical signal, with a high quantum efficiency of $\sim 85\%$ and a gain of $100$ \cite{NOvATechreport.pdf}. An example APD is shown on Fig.~\ref{fig:NOvAAPD}. Both ends of each fibre are connected to one of the 32 pixels on the APD, with each APD reading out signal from one module. To maximise the signal to noise ratio, the APDs are cooled to $\unit[-15]{\degree C}$ by a thermoelectric cooler, with head carried away by a water cooling system \cite{NOvATechreport.pdf}.
...
%More information from docdb:353 
...
\end{figure}
\fi
%%%% End of master's thesis for DAQ
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
